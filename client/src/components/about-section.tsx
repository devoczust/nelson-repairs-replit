        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="animate-fade-in">
            ...
            <p className="text-xl text-gray-700 mb-6 leading-relaxed">
              Com mais de <span className="font-bold text-primary">35 anos de experiência</span> no mercado, 
              Nelson se tornou uma referência em manutenção residencial em Curitiba. 
              Cada serviço é uma oportunidade de cuidar do seu lar com carinho e profissionalismo.
            </p>
            
            <p className="text-gray-600 mb-8 leading-relaxed">
              Especializado em resolver os desafios do dia a dia da sua casa, Nelson oferece 
            ...
            <div className="grid grid-cols-1 gap-4 mb-8">
              <div className="flex items-center p-4 bg-green-50 rounded-xl">
                ...
                <div>
                  <div className="font-semibold text-gray-800">Profissional Experiente e Confiável</div>
                  <div className="text-sm text-gray-600">Décadas de experiência em diversos tipos de reparo</div>
                </div>
              </div>
              ...
              <div className="flex items-center p-4 bg-blue-50 rounded-xl">
                ...
                <div>
                  <div className="font-semibold text-gray-800">Orçamentos Gratuitos e Transparentes</div>
                  <div className="text-sm text-gray-600">Sem surpresas, preços justos e claros</div>
                </div>
              </div>
              ...
              <div className="flex items-center p-4 bg-purple-50 rounded-xl">
                ...
                <div>
                  <div className="font-semibold text-gray-800">Garantia em Todos os Serviços</div>
                  <div className="text-sm text-gray-600">Tranquilidade e segurança para você</div>
                </div>
              </div>
              ...
              <div className="flex items-center p-4 bg-orange-50 rounded-xl">
                ...
                <div>
                  <div className="font-semibold text-gray-800">Atendimento Rápido e Pontual</div>
                  <div className="text-sm text-gray-600">Respeito ao seu tempo e urgência</div>
                </div>
              </div>
            </div>
