...
const services = [
  {
    ...
    description:
      "Instalação de tomadas, interruptores, luminárias, ventiladores de teto e pequenos reparos elétricos.",
    color: "bg-yellow-500",
    items: [
  ...
  },
  {
    ...
    description:
      "Conserto de vazamentos, desentupimento, troca de torneiras e pequenos reparos hidráulicos.",
    color: "bg-blue-500",
    items: ["Conserto de vazamentos", "Troca de torneiras", "Desentupimento"],
  },
  {
    icon: Package,
    title: "Montagem de Móveis",
    description:
      "Montagem e desmontagem de móveis, estantes, racks, camas e móveis planejados.",
    color: "bg-amber-700",
    items: ["Móveis planejados", "Estantes e racks", "Camas e guarda-roupas"],
  },
  {
    icon: PaintBucket,
    title: "Pintura e Acabamentos",
    description:
      "Pintura de paredes, retoques, aplicação de texturas e pequenos acabamentos.",
    color: "bg-purple-500",
    items: [
      "Pintura de paredes",
  ...
  },
  {
    ...
    description:
      "Conserto de portas, janelas, fechaduras, dobradiças e diversos reparos domésticos.",
    color: "bg-red-500",
    items: [
  ...
  },
  {
    ...
    description:
      "Instalação de TVs na parede, suportes, prateleiras, espelhos e objetos decorativos.",
    color: "bg-green-500",
    items: [
      "Instalação de TVs",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16 animate-fade-in">
          ...
          <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
            Cuidamos de todos os detalhes da sua casa com experiência
            profissional e ferramentas adequadas para cada tipo de serviço
          </p>
        </div>
          ...
          {services.map((service, index) => (
            ...
            >
              <CardContent className="p-8 relative">
                ...
                <div
                  className={`${service.color} p-4 rounded-xl inline-block mb-6 group-hover:scale-110 transition-transform duration-300`}
                >
        ...
        <div className="text-center mt-16 animate-fade-in">
          <div className="bg-white p-8 rounded-2xl shadow-warm max-w-2xl mx-auto">
            ...
            <a
              href={`https://wa.me/${PHONE}?text=Olá! Gostaria de solicitar um orçamento para serviços residenciais.`}
